package com.example.project_film.Activities;
...
import com.example.project_film.Adapters.ActorListAdapter;
import com.example.project_film.Adapters.CategoryEachFilmListAdapter;
import com.example.project_film.Adapters.CategoryListAdapter;
import com.example.project_film.Domain.FilmItem;
import com.example.project_film.R;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView titleTxt, moviesRateTxt, movieTimeTxt, movieSummaryInfo, movieActorInfo;
    private int idFilm;
    ...
    private void sendRequest() {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/" + idFilm, response -> {
            ...
            moviesRateTxt.setText(item.getImdbRating());
    ...
    private void initView() {
        ...
        moviesRateTxt = findViewById(R.id.movieStart);
